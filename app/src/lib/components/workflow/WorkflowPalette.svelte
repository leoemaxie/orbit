<script lang="ts">
	...
	const nodeTemplates: NodeTemplate[] = [
		...
		{ typeId: 's3_storage', label: 'Amazon S3 Storage', category: 'storage', adapterType: 'custom', iconName: 'Cloud', description: 'Upload JSON and reports to S3 bucket', defaultConfig: { bucket_name: 'orbit-exports', region: 'us-east-1', endpoint_url: '', access_key: '', secret_key: '' } },
		...
		{ typeId: 'email_alert', label: 'Email Notifications', category: 'notify', adapterType: 'both', iconName: 'Mail', description: 'Managed platform email alerts & custom SMTP delivery', defaultConfig: { mode: 'managed', recipient_email: 'team@company.com', notify_on_anomaly: true, sender_address: 'alerts@company.com', smtp_host: 'smtp.mailgun.org', smtp_port: 587, smtp_username: '', smtp_password: '', use_tls: true } },
