<script lang="ts">
	...
	const nodeTemplates: NodeTemplate[] = [
		...
		{ typeId: 'email_alert', label: 'Email Notifications', category: 'notify', adapterType: 'custom', iconName: 'Mail', description: 'Transactional email alerts with attached telemetry and dossier links', defaultConfig: { recipient_email: 'team@company.com', sender: 'orbit@notifications.orbit.local', api_key: '' } },
