<script lang="ts">
	...
	const nodeTemplates: NodeTemplate[] = [
		...
		{ typeId: 'email_alert', label: 'Email Notifications', category: 'notify', adapterType: 'custom', iconName: 'Mail', description: 'Executive email alerts & summary briefings', defaultConfig: { recipient_email: 'team@company.com', notify_on_anomaly: true } },
