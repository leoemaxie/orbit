<script lang="ts">
	...
	const nodeTemplates: NodeTemplate[] = [
		...
		{ typeId: 's3_storage', label: 'S3 Object Storage', category: 'storage', adapterType: 'custom', iconName: 'Cloud', description: 'Upload JSON and reports to S3 bucket', defaultConfig: { bucket_name: 'orbit-exports', region: 'us-east-1', endpoint_url: '', access_key: '', secret_key: '' } },
