<script lang="ts">
	...
	const nodeTemplates: NodeTemplate[] = [
		...
		{ typeId: 'email_alert', label: 'Email Notifications', category: 'notify', adapterType: 'both', iconName: 'Mail', description: 'Managed platform email alerts & custom delivery', defaultConfig: { mode: 'managed', recipient_email: 'team@company.com', notify_on_anomaly: true, sender_address: '', api_key: '', base_url: '' } },
